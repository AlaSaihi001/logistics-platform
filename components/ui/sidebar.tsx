...
export function Sidebar({ className, children }: SidebarProps) {
  return (
    <div
      className={cn(
        "hidden border-r bg-card md:block md:w-48 md:flex-col",
        className
      )}
    >
...
export function SidebarSection({
  ...
  return (
    <div className={cn("py-2", className)}>
      {title && (
        <h3 className="px-4 py-1 text-xs font-medium text-muted-foreground uppercase">
          {title}
        </h3>
      )}
...
const SidebarHeader_LEGACY = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
SidebarHeader_LEGACY.displayName = "SidebarHeader";

const SidebarFooter_LEGACY = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
SidebarFooter_LEGACY.displayName = "SidebarFooter";
...
export {
  ...
  SidebarTrigger,
  useSidebar,
  SidebarHeader_LEGACY,
  SidebarFooter_LEGACY,
};
