...
export default function LoginPage() {
  ...
  const redirectTo = `/dashboard/assistant`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/client-auth/assistant-login", {
        method: "POST",
        headers: {
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card>
          <CardHeader className="flex justify-center items-center">
            <CardTitle>Connexion Assistant</CardTitle>
            <CardDescription>
              Connectez-vous à votre compte assistant
            </CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
