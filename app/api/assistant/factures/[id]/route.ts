...
import { getFactureDetails, envoyerFactureClient } from "@/lib/assistant-service"
...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return ApiResponse.serverError("Une erreur est survenue lors de la récupération des détails de la facture")
  }
}
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return ApiResponse.serverError("Une erreur est survenue lors de la mise à jour de la facture")
  }
}
